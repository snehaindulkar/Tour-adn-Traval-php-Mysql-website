                ...
                <div class="container inner">
                    <div class="row">
                        <div class="text-center">
                            <h2 class="main-title">England Tour Packages</h2>
                            <hr>
                        </div>
                        <div class="divide50"></div>
                        <div class="col-sm-4">
                          <figure><img src= "../IMAGES/england.jpg" alt="" style="width:100%;height: 300px;"></figure>
                        </div>
                        <div class="col-sm-8">
                          <h4>Visiting place</h4>
                          <p>One of the four countries that makes United Kingdom is an empire of English history! Unchanged with time when it comes to cultural landmark yet advanced in development is what you will observe here in England. Explore the architecture draped in the essence of theatre and Roman history, bringing the idea of immortality of time alive. England is the perfect symphony between history and modernity! Veena World understands this region’s unique potential and frames intricate itineraries into England travel packages. The architectural specimens are so many and can be found on the every corner of the region. Here at Veena World, England holiday packages are intricately tailor-made to provide you a perfect vacation. Travelling is known to bring people together as we grow with every tour.</p>
                        </div>
                      </div>
                     <div class="divide50"></div>
                      <div class="row">
                        ...
                        <div class="col-sm-4">
                          ...
                          <ol class="color">
                            <li>Mysterious yet Magnificent - Stonehenge, England.</li>
                            <li>Giant's Causeway & Carrick-a-Rede Ropeway Bridge.</li>
                            <li>Shakespeare's birthplace at Stratford-upon-Avon.</li>
                            <li>Visit Millenium Stadium Cardiff Arms Park in Wales.</li>
                            <li>Explore the iconic Edinburgh Castle in Scotland</li>
