...
.active {
  background-color: navy    ;
    ...
    <body>
        ...
        <ul>
  <li><a class="active" href="../PHP/index.php">Home</a></li>
  <li><a href="#">World</a></li>
  <li><a href="../PHP/userdashboard.php">Login</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3 text-center">
                        ...
                        <a href="../PHP/registerform.php" class="btn booking-btn text-center" data-toggle="modal" data-target="#booking">Click for Booking !</a>
                    </div>
                </div>
            </div>
        </div>
